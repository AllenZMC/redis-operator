...
import (
	...
	scheme "github.com/jw-s/redis-operator/pkg/generated/clientset/versioned/scheme"
...
type RedisInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.Redis, error)
	List(opts metav1.ListOptions) (*v1.RedisList, error)
...
func (c *redises) Get(name string, options metav1.GetOptions) (result *v1.Redis, err error) {
	result = &v1.Redis{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) List(opts metav1.ListOptions) (result *v1.RedisList, err error) {
	result = &v1.RedisList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("redises").
...
func (c *redises) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *redises) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("redises").
