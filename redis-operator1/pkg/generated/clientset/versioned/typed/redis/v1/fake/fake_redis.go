...
func (c *FakeRedises) Get(name string, options v1.GetOptions) (result *redisv1.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(redisesResource, c.ns, name), &redisv1.Redis{})

	if obj == nil {
		return nil, err
	}
	return obj.(*redisv1.Redis), err
}

// List takes label and field selectors, and returns the list of Redises that match those selectors.
func (c *FakeRedises) List(opts v1.ListOptions) (result *redisv1.RedisList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(redisesResource, redisesKind, c.ns, opts), &redisv1.RedisList{})
	...
	list := &redisv1.RedisList{ListMeta: obj.(*redisv1.RedisList).ListMeta}
	for _, item := range obj.(*redisv1.RedisList).Items {
...
func (c *FakeRedises) Create(redis *redisv1.Redis) (result *redisv1.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(redisesResource, c.ns, redis), &redisv1.Redis{})
...
func (c *FakeRedises) Update(redis *redisv1.Redis) (result *redisv1.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(redisesResource, c.ns, redis), &redisv1.Redis{})
...
func (c *FakeRedises) UpdateStatus(redis *redisv1.Redis) (*redisv1.Redis, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(redisesResource, "status", c.ns, redis), &redisv1.Redis{})
...
func (c *FakeRedises) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(redisesResource, c.ns, name), &redisv1.Redis{})
...
func (c *FakeRedises) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &redisv1.RedisList{})
	return err
}

// Patch applies the patch and returns the patched redis.
func (c *FakeRedises) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *redisv1.Redis, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(redisesResource, c.ns, name, data, subresources...), &redisv1.Redis{})
